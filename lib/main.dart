...
import 'package:shakti/Onboarding/onboarding_screen.dart';
import 'package:shakti/background_services.dart';
        ...
        builder: (context, AsyncSnapshot<bool> snap) {
          ...
          if (snap.connectionState == ConnectionState.done) {
            if (snap.hasData && snap.data != null) {
              if (snap.data!) {
                return Onboarding(); // Return Dashboard if app opened before
              } else {
